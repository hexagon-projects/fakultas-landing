<template>
  <div class="p-8 w-full">
    <footer
      class="w-full bg-[#AA2132] text-white p-6 mx-auto rounded-4xl shadow-lg relative overflow-hidden"
    >
      ...
      <div class="max-w-full mx-auto flex flex-col gap-6 relative z-10">
          ...
          <div class="flex flex-col gap-4 w-full md:w-auto lg:w-[60%]">
            ...
            <div class="flex gap-4">
              <a
                ...
                class="text-white hover:text-[#FEF251] transition-colors duration-200 text-xl"
              >
                <i :class="social.icon" />
              </a>
            </div>
            ...
            <div class="flex flex-col gap-3">
              ...
              <nav class="flex flex-col gap-2">
                <a
                  ...
                  :key="link.path"
                  :href="link.path"
                  class="text-zinc-300 text-base hover:text-white hover:underline transition-colors duration-200"
                >
                  {{ link.label }}
                </a>
              </nav>
            ...
            <div class="flex flex-col gap-3">
              ...
              <div class="flex flex-col gap-2">
                <div
                  ...
                  class="flex flex-col"
                >
                  <p class="text-zinc-300 text-base">{{ campus.address }}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="w-full p-3 bg-[#FEF251] rounded-2xl text-center mt-4">
          <p class="text-[#1A1A1A] text-base md:text-lg font-medium">
...
const socialMedia = [
  ...
  { name: 'Instagram', icon: 'fab fa-instagram', url: 'https://www.instagram.com/pmbunpas' },
  {
    name: 'Facebook',
...
const navigationLinks = [
  { path: '/', label: 'Beranda' },
  { path: '/jalur', label: 'Jalur & Jadwal' },
  { path: '/fasilitas', label: 'Fasilitas' },
  { path: '/mahasiswa-dan-alumni', label: 'Mahasiswa & Alumni' },
  { path: '/prestasi', label: 'Prestasi' },
  { path: '/dukungan', label: 'Dukungan' },
