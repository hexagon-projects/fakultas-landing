    ...
    <div ref="timelineRef" class="relative z-0 mx-auto max-w-7xl pb-20">
      ...
      >
        ...
        >
          ...
          <div>
            <p class=" mt-14 md:mt-0 text-[12px] md:text-[10px] lg:text-[14px] font-bold md:pl-20 pb-2">12 Maret 2025</p>
            <h3
              class="mt-0 text-[18px] md:text-[20px] lg:text-[22px] font-bold md:block md:pl-20"
            >
              {{ item.label }}
            </h3>
