...
const props = withDefaults(defineProps<BorderBeamProps>(), {
  ...
  anchor: 90,
  borderWidth: 4,
colorFrom: "rgba(var(--color-primary-r), var(--color-primary-g), var(--color-primary-b), 1)",
  colorTo: "rgba(var(--color-primary-r), var(--color-primary-g), var(--color-primary-b), 0)",
  delay: 0,
});
