...
<template>
  <SectionLayout>
    ...
    <!-- DESKTOP LAYOUT -->
    <div class="hidden md:flex self-stretch justify-start items-center gap-14 mt-6">
      ...
      <div class="flex flex-col justify-start items-start gap-12">
        ...
        <div
          v-for="(card, index) in props.prospek.slice(0,5)"
          :key="index"
            ...
            <div class="flex justify-start items-center gap-2.5">
              <div class="w-11 h-11 relative overflow-hidden">
                <img
                  ...
                  alt="icon"
                  class="w-11 h-11 object-contain absolute left-[0.67px] top-[0.67px] svg-primary "
                />
              </div>
            </div>
