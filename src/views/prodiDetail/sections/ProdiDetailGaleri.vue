...
<template>
  <div
    ...
    <div v-if="fasilitas.length > 0"
      class="hidden md:grid grid-flow-row grid-cols-3 w-full h-[40vh] lg:h-[85vh] justify-center items-center gap-4 md:gap-10 lg:gap-14">
      <div class="w-full h-full row-span-2 rounded-[16px] md:rounded-[24px] lg:rounded-[32px] overflow-hidden relative group">
      ...
      <div class="w-full h-full col-span-2 rounded-[16px] md:rounded-[24px] lg:rounded-[32px] overflow-hidden relative group">
        <div class="absolute inset-0 bg-gradient-to-t from-colorPrimary/90 via-transparent to-transparent z-10"></div>
