...
<template>
  <div class="space-y-4 lg:space-y-6">
    <div
      class="w-full h-[40vh] md:h-[30vh] lg:h-[40vh] rounded-[16px] md:rounded-[24px] lg:rounded-[32px] overflow-hidden group dosen-container">
      <img :src="image || 'https://via.placeholder.com/300'" :alt="name || 'Dosen'"
        class="w-full h-full object-cover object-top group-hover:scale-105 transition duration-500 dosen-box">
    </div>
    <div class="space-y-2">
...
.dosen-box {
  clip-path: polygon(86% 100%, 100% 86%, 100% 0%, 14% 0%, 0% 14%, 0% 100%);
}
</style>
